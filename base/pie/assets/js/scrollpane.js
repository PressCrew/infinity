...
(function($){
	...
	var methods = {
		init: function(options)
		{
			...
			return this.each(function()
			{
				...
				var scrollPane =
						$(this)
							.addClass('pie-easy-ui-scroll-pane ui-widget ui-widget-content')
							.css('overflow', 'hidden'),
					scrollValue =
						$(settings.valueSelector, scrollPane)
							.addClass('pie-easy-ui-scroll-pane-value ui-widget-content'),
					scrollView =
						$(settings.viewSelector, scrollPane)
							.addClass('pie-easy-ui-scroll-pane-view'),
					scrollItems =
						$(settings.itemSelector, scrollView)
							.addClass('pie-easy-ui-scroll-pane-item')
							...
							.click(function(event){
								...
								scrollValue
									.children('.pie-easy-ui-scroll-pane-selected')
									.remove();
								anchor
									.clone()
									.appendTo(scrollValue)
									.addClass('pie-easy-ui-scroll-pane-selected');
							}),
					scrollItemActive =
				...
				var scrollBarWrap =
						$(settings.barWrapSelector, scrollPane)
							.addClass('pie-easy-ui-scroll-pane-bar-wrap ui-widget-content'),
					scrollBar =
						$(settings.barSelector, scrollBarWrap)
							.addClass('pie-easy-ui-scroll-pane-bar')
							.slider({
	...
	$.fn.pieEasyScrollPane = function (method)
	{
		if ( methods[method] ) {
			...
			return $.error('Method ' +  method + ' does not exist on jQuery.pieEasyScrollPane');
		}
	}
