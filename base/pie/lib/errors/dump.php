...
<body bgcolor="white" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
	...
	<div class="page">
		...
		<h4>
			<?php _print_string_safely( Pie_Easy_Error_Handler::$type ); ?> Type:
			<span><?php _print_string_safely( Pie_Easy_Error_Handler::$object_type ); ?></span>
		</h4>
			...
			foreach ( $GLOBALS as $var_key => $var_value ):
				...
				<li>
					...
					<div id="<?php _print_string_safely( $var_key ) ?>" class="var-dump" style="display: none;">
						<?php print Pie_Easy_Error_Handler::dump( $var_value, 10, true ); ?>
					</div>
				</li><?php
		...
		<div id="how-to-disable" class="code">
			...
			<pre class="code">define('PIE_EASY_ERROR_REPORTING', true);</pre>
			To completely disable PIE error handling (not recommended),
			add the following to wp-config.php or your functions.php::
			<pre class="code">define('PIE_EASY_ERROR_HANDLING', false);</pre>
		</div>
		...
		<center>
			<em>
				<?php _print_string_safely( Pie_Easy_Error_Handler::$type ); ?>
				Report Generated:
				<?php _print_string_safely( Pie_Easy_Error_Handler::$date_time_of_error ); ?>
			</em>
		</center>
