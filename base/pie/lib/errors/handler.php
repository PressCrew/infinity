<?php
/**
 * PIE API: error handler class file
 *
...
if ( !defined( 'PIE_EASY_ERROR_AJAX_MESSAGE' ) && PIE_EASY_ERROR_REPORTING == false ) {
	define( 'PIE_EASY_ERROR_AJAX_MESSAGE', 'Oops! An error has occurred. You can customize this message!' );
}

// set up error handling
set_error_handler(
	array( 'Pie_Easy_Error_Handler', 'handle_error' ),
	error_reporting()
);

// set up exception handling
set_exception_handler(
	array( 'Pie_Easy_Error_Handler', 'handle_exception' )
);
...
class Pie_Easy_Error_Handler
{
	...
	protected static function run()
	{
		...
		if ( PIE_EASY_AJAX_REQUEST ) {
			...
			// spit out message?
			if ( defined( 'PIE_EASY_ERROR_AJAX_MESSAGE' ) ) {
				// spit out customizable error
				print PIE_EASY_ERROR_AJAX_MESSAGE;
			} else {
			...
			if ( defined('PIE_EASY_ERROR_PAGE_PATH') && PIE_EASY_ERROR_PAGE_PATH ) {
				...
				// load the error page
				require( PIE_EASY_ERROR_PAGE_PATH );
 ...
 * @license http://www.opensource.org/licenses/mit-license.php
 */
class Pie_Easy_Error_Attribute
{
	/**
	 * Label
	 *
