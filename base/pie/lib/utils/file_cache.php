<?php
/**
 * PIE API: file system file cache class file
 *
...
Pie_Easy_Loader::load( 'utils/file' );
 ...
 * @subpackage utils
 */
final class Pie_Easy_File_Cache extends Pie_Easy_Map
{
	/**
	 ...
	 * @return Pie_Easy_File The fstat instance for the filename
	 */
	 ...
	 *
	 * @param string $filename
	 * @return Pie_Easy_File|null The removed fstat object, null if no such filename exists.
	 */
