<?php
/**
 * PIE API: widget extensions, theme picker template file
 *
...
<div id="<?php $this->render_id() ?>" class="<?php $this->render_classes() ?> ui-widget">
	...
	<div class="ui-widget-content">
		...
		<a href="#"><?php _e( 'Launch Theme Browser', pie_easy_text_domain ) ?></a>
	</div>
</div>
	...
	var tbrowser =
		jQuery('div#<?php $this->render_id( 'dialog' ) ?>')
			.dialog({
				...
				minHeight: 720,
				minWidth: 800,
				title: '<?php _e( 'Theme Browser', pie_easy_text_domain ) ?>'
			});
