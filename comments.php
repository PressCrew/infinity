...
<?php
 ...
 if ( have_comments() ) {
 	...
 	<h3 id="comments-title"><?php printf( _n( 'One Response to %2$s', '%1$s Responses to %2$s', get_comments_number(), 'infinity' ), number_format_i18n( get_comments_number() ), '<em>' . get_the_title() . '</em>' ); ?></h3>
...
if ( ! empty($comments_by_type['pings']) ) { ?>
 	<h3 id="comments-title"><?php  _e('Trackbacks/Pingbacks', 'infinity'); ?></h3>
 	<ol class="commentlist">
		<?php
