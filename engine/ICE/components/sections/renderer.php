 ...
 * @subpackage sections
 */
class ICE_Section_Renderer extends ICE_Renderer
{
	/**
	...
	{
		$class_title = $this->component()->get_property( 'class_title' );
	...
	{
		$class_content = $this->component()->get_property( 'class_content' );
