	...
	<div id="header">
		<div id="masthead">
			<div id="branding" role="banner">
				<?php
					// show infinity header logo?
					if ( !infinity_feature( 'infinity-header-logo' ) ):
						// no, use fallback header stuff
						$heading_tag = ( is_home() || is_front_page() ) ? 'h1' : 'div';
						// could be an h1 OR a div ?>
			...
			<div id="access" role="navigation">
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', infinity_text_domain ); ?>"><?php _e( 'Skip to content', infinity_text_domain ); ?></a></div>
