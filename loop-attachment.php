<?php
/**
 * Infinity Theme: attachment loop template
 *
...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( ! empty( $post->post_parent ) ) : ?>
					<p class="page-title"><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr( printf( __( 'Return to %s', infinity_text_domain ), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
						/* translators: %s - title of parent post */
						printf( __( '<span class="meta-nav">&larr;</span> %s', infinity_text_domain ), get_the_title( $post->post_parent ) );
					?></a></p>
				<?php endif; ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="entry-meta">
						<?php
							printf( __( '<span class="%1$s">By</span> %2$s', infinity_text_domain ),
						...
						<?php
							printf( __( '<span class="%1$s">Published</span> %2$s', infinity_text_domain ),
...
?>
						<p class="attachment"><a href="<?php echo $next_attachment_url; ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="attachment"><?php
							$attachment_width  = apply_filters( 'infinity_attachment_size', 900 );
							$attachment_height = apply_filters( 'infinity_attachment_height', 900 );
