<?php
/**
 * Infinity Theme: single post loop template
 *
...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<div id="nav-above" class="navigation">
					<div class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', infinity_text_domain ) . '</span> %title' ); ?></div>
					<div class="nav-next"><?php next_post_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', infinity_text_domain ) . '</span>' ); ?></div>
				</div><!-- #nav-above -->
...
<?php if ( get_the_author_meta( 'description' ) ) : // If a user has filled out their description, show a bio on their entries  ?>
					<div id="entry-author-info">
						...
						<div id="author-description">
							<h2><?php printf( esc_attr__( 'About %s', infinity_text_domain ), get_the_author() ); ?></h2>
