...
<?php /* How to display posts of the Gallery format. The gallery category is the old way. */ ?>
	...
	<?php if ( ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) || in_category( _x( 'gallery', 'gallery category slug', infinity_text_domain ) ) ) : ?>
...
<?php else : ?>
				...
				?>
						...
						<p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, infinity_text_domain ),
...
<?php endif; ?>
			...
			<?php if ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) : ?>
				<a href="<?php echo get_post_format_link( 'gallery' ); ?>" title="<?php esc_attr_e( 'View Galleries', infinity_text_domain ); ?>"><?php _e( 'More Galleries', infinity_text_domain ); ?></a>
				<span class="meta-sep">|</span>
			<?php elseif ( in_category( _x( 'gallery', 'gallery category slug', infinity_text_domain ) ) ) : ?>
...
<?php /* How to display posts of the Aside format. The asides category is the old way. */ ?>
	...
	<?php elseif ( ( function_exists( 'get_post_format' ) && 'aside' == get_post_format( $post->ID ) ) || in_category( _x( 'asides', 'asides category slug', infinity_text_domain ) )  ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
